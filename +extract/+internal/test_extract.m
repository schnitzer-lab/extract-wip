...
extract.internal.plot_cells_overlay(output.spatial_weights);
...
hold off
extract.internal.plot_cells_overlay(reshape(F_ground, h, w, size(F_ground, 2)), 'g');
extract.internal.plot_cells_overlay(reshape(S, h, w, size(S, 2)), 'w');
