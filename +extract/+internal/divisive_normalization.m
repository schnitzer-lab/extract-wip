function data = divisive_normalization(data, avg_radius, tol)
    ...
    % Remove nans
    data = extract.internal.replace_nans_with_zeros(data);
    ...
    smooth_data = extract.internal.spatial_bandpass(data, avg_radius, inf, 1 / tol, use_gpu);
    data = data ./ smooth_data;

    % Send back to GPU if data was on GPU originally
    data = extract.internal.maybe_gpu(is_input_gpuArray, data);
