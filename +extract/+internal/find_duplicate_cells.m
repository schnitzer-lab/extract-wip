function idx_trash = find_duplicate_cells(S, Tt, overlap_idx)
    ...
    cc_image = extract.internal.find_conncomp(S(:, idx_select), S_corr_thresh);
    ...
    for k = 1:length(cc_image)
        ...
        cc_trace = extract.internal.find_conncomp(Tt(:, idx_with_spat_overlap), ...
        T_dup_thresh);
        idx_trash_this = [];
        ...
        [cc_trace, C] = extract.internal.find_conncomp(Tt(:, idx_with_spat_overlap), ...
        T_corr_thresh);
