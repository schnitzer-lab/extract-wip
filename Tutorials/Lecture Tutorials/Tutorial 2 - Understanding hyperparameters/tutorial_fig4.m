...
clear;
M = single(h5read('Fig4_example.h5', '/data'));
%%
config = [];
...
extract.internal.plot_cells_overlay(output.spatial_weights, [1, 0, 0], [])
%% Check movie
extract.internal.view_movie(M, 'ims', output.spatial_weights, 'im_colors', [1, 0.5, 0])
